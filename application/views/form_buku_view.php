...
<head>
    ...
    <title>Tambah Buku - Yayasan Citra Bina Insan Mandiri</title>
...
<body>
    ...
    <main class="container">
        <h2 class="form-page-title"><i class="fas fa-book"></i> Tambah Buku Baru</h2>
        
        <form method="post" action="<?= site_url('katalog/tambah_buku') ?>" enctype="multipart/form-data" class="book-form">
                ...
                <div class="form-group full-width">
                    ...
                    <div class="file-upload">
                        ...
                        <label for="cover" class="file-upload-label">
                            ...
                            <span>Drag & drop file cover atau <strong>klik untuk memilih</strong></span>
                            <span class="file-name" id="file-name">Belum ada file dipilih</span>
                        </label>
                        <img id="cover-preview" class="cover-preview" alt="Preview Cover">
                    </div>
                </div>
            </div>
    ...
    <footer class="footer">
        <div class="container footer-content">
            ...
            <div class="footer-info">
                ...
                <p>Email: info@cbim-foundation.org | Telp: (021) 1234567</p>
            </div>
